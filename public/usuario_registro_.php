            ...
            <div class="column col-9">
                <form method="POST" novalidate action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                    ...
                    <div class="mt-2">
                        ...
                        <span class="text-danger">
                            <?php if (isset($errores['materno']))
                                print($errores['materno']) ?>
                            </span>
                        </div>
                        <div class="mt-2">
